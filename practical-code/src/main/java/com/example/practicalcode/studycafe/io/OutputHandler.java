...
import com.example.practicalcode.studycafe.model.pass.StudyCafePass;
...
public class OutputHandler {
    ...
    public void showPassOrderSummary(StudyCafePassOrder passOrder) {
        ...
        Optional<StudyCafeLockerPass> orderLockerPass = passOrder.getLockerPass();

        System.out.println();
        System.out.println("이용 내역");
        System.out.println("이용권: " + display(selectedPass));

        orderLockerPass.ifPresent(lockerPass ->
